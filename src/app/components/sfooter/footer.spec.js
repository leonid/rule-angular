...
describe( 'Footer', () => {
  ...
  describe( 'Component', () => {
    ...
    it( 'should contain sfooter component', () => {
      element = render();
    ...
    it( 'should contain copyright link', () => {
      element = render();
      let copyrightLink = angular.element( element[0].querySelector( '#sfooter div a' ) );
    ...
    it( 'should contain copyright text', () => {
      ...
      let copyrightText = angular.element( element[0].querySelector( '#sfooter div' ) );
