...
import {ACCESS_LEVELS, USER_ROLES} from '../../common/constants/constants.js'
import Header from './header.js'

describe( 'Header', () => {
  let component = '<pps-header></pps-header>'
    ...
    describe( 'navigation', () => {
      describe( 'Schedule', () => {
        ...
        it( 'should redirect to Schedule page', () => {
          ...
          expect( nav.attr( 'ui-sref' ) ).toEqual( 'pps.resources' )
        } )
      } )
      ...
      describe( 'Availability', () => {
        ...
        it( 'should redirect to Availability page', () => {
          ...
          expect( nav.attr( 'ui-sref' ) ).toEqual( 'pps.availability' )
        } )
      } )
      ...
      describe( 'Documents', () => {
        ...
        it( 'should redirect to Documents page', () => {
          ...
          expect( nav.attr( 'ui-sref' ) ).toEqual( 'pps.documents' )
        } )
      } )
      ...
      describe( 'Resources', () => {
        it( 'should contain Employees label', () => {
          ...
          expect( nav.text().trim() ).toEqual( 'Resources' )
        } )

        it( 'should redirect to Resources page', () => {
          spyOn( AuthenticationService, 'getCurrentUser' ).and.returnValue( {role: USER_ROLES.ADMIN} )
        ...
        it( `should not display resources link for ${USER_ROLES.EMPLOYEE} role`, () => {
          spyOn( AuthenticationService, 'getCurrentUser' ).and.returnValue( {role: USER_ROLES.EMPLOYEE} )
          element = render()
          const nav = angular.element( element[0].querySelector( '.navbar-nav.navbar-left li:nth-child(4) a' ) )
      ...
      describe( 'Partners', () => {
        ...
        it( 'should redirect to Partners page', () => {
          ...
          expect( nav.attr( 'ui-sref' ) ).toEqual( 'pps.partners' )
        } )
      ...
      describe( 'Reports', () => {
        ...
        it( 'should redirect to Reports page', () => {
          ...
          expect( nav.attr( 'ui-sref' ) ).toEqual( 'pps.reports' )
        } )
      ...
      describe( 'My Account', () => {
        ...
        it( 'should redirect to My Account page', () => {
          ...
          expect( nav.attr( 'ui-sref' ) ).toEqual( 'pps.account.account-details' )
        } )
      } )
      ...
      describe( 'App Settings', () => {
        ...
        it( 'should redirect to App Settings page', () => {
          ...
          expect( nav.attr( 'ui-sref' ) ).toEqual( 'pps.settings.positions' )
        } )
