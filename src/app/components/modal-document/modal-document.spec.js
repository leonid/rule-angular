...
import document from '../../common/resources/document/fixtures/document_1.json'
...
describe( 'DocumentModal', () => {
    ...
    describe( 'Form fields', () => {
      ...
      describe( 'selectedEmployeeWithoutAccess', () => {
        ...
        it( 'should show dropdown options order by firstName', () => {
          const employeesWithoutAccess = [{id: '1', firstName: 'B', lastName: 'test'}, {
              id: '2',
              firstName: 'A',
              lastName: 'test'
            }, {id: '3', firstName: 'C', lastName: 'test'}],
      ...
      describe( 'selectedEmployeeWithAccess', () => {
        ...
        it( 'should show dropdown options order by firstName', () => {
          const employeesWithAccess = [{id: '1', firstName: 'B', lastName: 'test'}, {
              id: '2',
              firstName: 'A',
              lastName: 'test'
            }, {id: '3', firstName: 'C', lastName: 'test'}],
  ...
  describe( 'Controller', () => {
    ...
    it( `should have employeesWithAccess set to filtered employees with access for document id that is defined`, () => {
      const document = {id: 'id', employees: ['1', '2']}, employees = [{
        id: '1',
        name: 'name1'
    ...
    describe( 'save', () => {
      ...
      it( 'should add employeesWithAccess to document.employees if document is locked', () => {
        let form = {$valid: true}, document = {
          id: 'id',
          employees: [],
          isLocked: true
        }, employees = [{id: '1', name: 'name1'}, {id: '2', name: 'name2'}, {
          id: '3',
          name: 'name3'
        }];
        spyOn( DocumentModel, 'getItem' ).and.returnValue( document );
