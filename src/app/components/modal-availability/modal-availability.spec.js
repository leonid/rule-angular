...
describe( 'ModalAvailability', () => {
  ...
  describe( 'Controller', () => {
    ...
    itAsync( 'should save if form is valid', () => {
      let form = {
        $valid: true, $setPristine: () => {
        }
      };
      const availability = {
        availability: itemMock.availability,
        start: itemMock.start.format( AVAILABILITY_DATE_FORMAT ),
        end: itemMock.end.format( AVAILABILITY_DATE_FORMAT ),
        employeeId: itemMock.employeeId
      };
      spyOn( AvailabilityModel, 'getItem' ).and.returnValue( itemMock );
    ...
    it( 'should save with `note` property if exist', () => {
      ...
      const availability = {
        availability: clonedAvailability.availability,
        start: clonedAvailability.start.format( AVAILABILITY_DATE_FORMAT ),
        end: clonedAvailability.end.format( AVAILABILITY_DATE_FORMAT ),
        employeeId: clonedAvailability.employeeId,
        note: clonedAvailability.note
      };
