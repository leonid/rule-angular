...
//import employee from '../../common/resources/employee/fixtures/employee_1.json'
  ...
  describe( 'Controller', () => {
    ...
    it( 'should have locations property', () => {
      spyOn( LocationModel, 'getCollection' ).and.returnValue( [{
        status: EMPLOYEE_PROFILE_STATUSES.ACTIVE,
        default: true
      }, {status: EMPLOYEE_PROFILE_STATUSES.INACTIVE, default: false}] );

      employeeAuthorizations = new EmployeeAuthorizations( EmployeeModel, LocationModel );

      expect( employeeAuthorizations.locations.length ).toEqual( 1 );
      expect( employeeAuthorizations.locations ).toEqual( [{
        status: EMPLOYEE_PROFILE_STATUSES.ACTIVE,
        default: true
      }] );
    ...
    it( `should have employee.locations set to default location if employee.locations is undefined`, () => {
      ...
      spyOn( LocationModel, 'getCollection' ).and.returnValue( [{
        ...
        id: '1',
        default: false
      }, {status: EMPLOYEE_PROFILE_STATUSES.ACTIVE, id: '2', default: true}] );
