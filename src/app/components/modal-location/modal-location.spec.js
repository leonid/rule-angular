...
import location from '../../common/resources/location/fixtures/location_1.json'
    ...
    describe( 'save', () => {
      ...
      describe( 'when displayDefaultOptions and location.default are set to true', () => {
        it( 'should set defaultLocation to false', () => {
          let clonedObject = Object.assign( {
            id: 'id',
            default: false
          }, itemMock ), form = {$valid: true}, defaultLocation = {default: true};
          spyOn( LocationModel, 'getItem' ).and.returnValue( clonedObject );
        ...
        it( `should set location.status to ${EMPLOYEE_PROFILE_STATUSES.ACTIVE}`, () => {
          let clonedObject = Object.assign( {
            id: 'id',
            default: false,
            status: EMPLOYEE_PROFILE_STATUSES.INACTIVE
          }, itemMock ), defaultLocation = {default: true}, form = {$valid: true};
          spyOn( LocationModel, 'getItem' ).and.returnValue( clonedObject );
          spyOn( LocationModel, 'getDefaultLocation' ).and.returnValue( defaultLocation );
        ...
        itAsync( `should not save data and return failure`, () => {
          let clonedObject = Object.assign( {
            ...
            default: false,
            status: EMPLOYEE_PROFILE_STATUSES.INACTIVE
          }, itemMock ), defaultLocation = {default: true}, form = {$valid: true}, response = {status: 404};
          spyOn( LocationModel, 'getItem' ).and.returnValue( clonedObject );
          spyOn( LocationModel, 'getDefaultLocation' ).and.returnValue( defaultLocation );
