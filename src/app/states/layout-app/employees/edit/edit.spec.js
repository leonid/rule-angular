...
describe( 'EmployeeEdit', () => {
  ...
  describe( 'Controller', () => {
    let $state, employeeEdit, FormService, EmployeeModel, itemMock = {
      firstName: 'firstName',
      lastName: 'lastName',
      avatar: 'avatar'
    };
    ...
    it( 'should have formSteps property', () => {
      ...
      expect( employeeEdit.formSteps ).toEqual( [
        {
          route: 'app.employees.edit.account-details',
          formName: 'employeeAccountDetailsForm',
          valid: false
        },
        {
          route: 'app.employees.edit.contact-details',
          formName: 'employeeContactDetailsForm',
          valid: true
        },
        {
          route: 'app.employees.edit.bank-details',
          formName: 'employeeBankDetailsForm',
          valid: true
        },
        {route: 'app.employees.edit.hourly-rate', formName: 'employeeHourlyRateForm', valid: false},
        {
          route: 'app.employees.edit.authorizations',
