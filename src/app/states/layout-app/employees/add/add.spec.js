...
import {PROFILE_COMPLETENESS_TYPES, USER_ROLES} from '../../../../common/constants/constants';
...
describe( 'EmployeeAdd', () => {
  ...
  describe( 'Controller', () => {
    let $state, $rootScope, employeeAdd, FormService, EmployeeModel, itemMock = {
      firstName: 'firstName',
      lastName: 'lastName',
      avatar: 'avatar'
    };
    ...
    it( 'should have formSteps property for admin users', () => {
      ...
      expect( employeeAdd.formSteps ).toEqual( [
        {
          route: 'app.employees.add.account-details',
          formName: 'employeeAccountDetailsForm',
          valid: false
        },
        {
          route: 'app.employees.add.contact-details',
          formName: 'employeeContactDetailsForm',
          valid: true
        },
        ...
        {
          route: 'app.employees.add.authorizations',
          formName: 'employeeAuthorizationsForm',
          valid: true
        },
